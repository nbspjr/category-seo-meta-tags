...
/**
 * @brief Callback for aioseop_title filter (by All in One SEO plugin)
 *
 * @param string $title Original title generated by All in One SEO plugin
 *
 * @return string formatted title
 */
function csmt_category_seo_title($title) {
	if ( is_category() ) {
		return show_category_title();
	} elseif ( is_tag() || is_tax()  ) {
		return show_tag_title();
	}

	// If it gets here, just return the original title without modifying it
	return $title;
}
...
add_filter('aioseop_title', 'csmt_category_seo_title');
